...
echo "deb [arch=$(dpkg --print-architecture) signed-by=/usr/share/keyrings/sunrise.gpg]  http://archive.d-robotics.cc/ubuntu-rdk-x5-beta noble main" | sudo    tee /etc/apt/sources.list.d/sunrise.list > /dev/null
...
#cp -rf ../sysroot_docker_noble/usr_x5/lib/aarch64-linux-gnu/libcrypto.so.1.1 /usr/lib/aarch64-linux-gnu/
